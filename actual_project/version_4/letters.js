        ...
        <div class="row">
          <div class="col-md-12">
            <label
              ...
              ><b>Element No: ${newCustomElementCount}</b></label
            >
          </div>
        </div>
        <div class="row mb-3">
        ...
        <div class="row">
          ...
          >
            <button
              ...
              onclick="removeDocumentElement(${newCustomElementCount})"
            >
              <i
...
const saveCustomTemplate = async () => {
  ...
  // Save Template to Object Store instead of Downloading same
  // const blob = new Blob([customTemplate], { type: "application/json" });
  // const url = URL.createObjectURL(blob);

  // const link = document.createElement("a");
  // link.href = url;
  // link.download = customTemplateName;
  ...
  await saveTemplateToDB(customTemplate);
