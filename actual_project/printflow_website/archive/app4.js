/* ==========================================================================
   PrintFlow Landing Page V4 - Vibrant Light Theme Layout Script
   Handles Canvas Simulator V4 and CMYK Simulator V4.
   ========================================================================== */
...
/* ==========================================================================
   1. Canvas Playground Simulator V4
   ========================================================================== */
function initCanvasPlayground() {
    const presetSelect = document.getElementById("sheet-preset4");
    const simPaper = document.getElementById("sim-paper4");
    const dragElement = document.getElementById("drag-element4");
    const coordsDisplay = document.getElementById("coords-display4");
    const statusBadge = document.getElementById("status-badge4");
    const statusText = document.getElementById("status-text4");
    const playgroundCard = document.getElementById("playground");

    // Coordinate Indicators
    const coordXInd = document.getElementById("ruler-x4");
    const coordYInd = document.getElementById("ruler-y4");
    ...
    function updatePreset() {
        ...
        const safeGuide = document.getElementById("guide-safe4");
        if (safeGuide) {
        ...
        document.getElementById("metric-w4").textContent = config.elWidthMm;
        document.getElementById("metric-h4").textContent = config.elHeightMm;
    ...
    function evaluateSafety(leftPx, topPx, elW, elH, config) {
        ...
        if (overlapsTrim) {
            ...
            statusBadge.className = "status-indicator-v4 px-3 py-1 rounded-pill danger";
            ...
            statusBadge.className = "status-indicator-v4 px-3 py-1 rounded-pill safe";
...
/* ==========================================================================
   2. CMYK Gamut Simulator V4
   ========================================================================== */
function initCmykSimulator() {
    const sliderC = document.getElementById("slider-c4");
    const sliderM = document.getElementById("slider-m4");
    const sliderY = document.getElementById("slider-y4");
    const sliderK = document.getElementById("slider-k4");

    const valC = document.getElementById("val-c4");
    const valM = document.getElementById("val-m4");
    const valY = document.getElementById("val-y4");
    const valK = document.getElementById("val-k4");

    const gamutPreview = document.getElementById("gamut-preview4");
    const rgbLabel = document.getElementById("gamut-rgb-val4");
    const warningBox = document.getElementById("gamut-warning-box4");
    const warningText = document.getElementById("gamut-warning-text4");
    ...
    function updateColor() {
        ...
        if (totalInk > 280) {
            warningBox.className = "gamut-indicator-bar-v4 out-of-gamut d-flex p-3 rounded";
            ...
            warningBox.className = "gamut-indicator-bar-v4 safe-gamut d-flex p-3 rounded";
