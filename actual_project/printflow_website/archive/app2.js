/* ==========================================================================
   PrintFlow Landing Page V2 - Minimalist Javascript Layout
   Handles Canvas Simulator V2 and CMYK Simulator V2.
   ========================================================================== */
...
/* ==========================================================================
   1. Canvas Playground Simulator V2
   ========================================================================== */
function initCanvasPlayground() {
    const presetSelect = document.getElementById("sheet-preset2");
    const simPaper = document.getElementById("sim-paper2");
    const dragElement = document.getElementById("drag-element2");
    const coordsDisplay = document.getElementById("coords-display2");
    const statusBadge = document.getElementById("status-badge2");
    const statusText = document.getElementById("status-text2");
    const playgroundCard = document.getElementById("playground");

    // Coordinate Indicators
    const coordXInd = document.getElementById("ruler-x2");
    const coordYInd = document.getElementById("ruler-y2");
    ...
    function updatePreset() {
        ...
        const safeGuide = document.getElementById("guide-safe2");
        if (safeGuide) {
        ...
        document.getElementById("metric-w2").textContent = config.elWidthMm;
        document.getElementById("metric-h2").textContent = config.elHeightMm;
    ...
    function evaluateSafety(leftPx, topPx, elW, elH, config) {
        ...
        if (overlapsTrim) {
            ...
            statusBadge.className = "status-indicator-v2 px-3 py-1 rounded-pill danger";
            ...
            statusBadge.className = "status-indicator-v2 px-3 py-1 rounded-pill safe";
...
/* ==========================================================================
   2. CMYK Gamut Simulator V2
   ========================================================================== */
function initCmykSimulator() {
    const sliderC = document.getElementById("slider-c2");
    const sliderM = document.getElementById("slider-m2");
    const sliderY = document.getElementById("slider-y2");
    const sliderK = document.getElementById("slider-k2");

    const valC = document.getElementById("val-c2");
    const valM = document.getElementById("val-m2");
    const valY = document.getElementById("val-y2");
    const valK = document.getElementById("val-k2");

    const gamutPreview = document.getElementById("gamut-preview2");
    const rgbLabel = document.getElementById("gamut-rgb-val2");
    const warningBox = document.getElementById("gamut-warning-box2");
    const warningText = document.getElementById("gamut-warning-text2");
    ...
    function updateColor() {
        ...
        if (totalInk > 280) {
            warningBox.className = "gamut-indicator-bar-v2 out-of-gamut d-flex p-3 rounded";
            ...
            warningBox.className = "gamut-indicator-bar-v2 safe-gamut d-flex p-3 rounded";
